...
export default function AdminPanel(props) {
  ...
  return (
    <>
      <div>
        <button className="btn btn-primary" onClick={()=>navigate('add')}>Add New Product</button>
        <button className="btn btn-success" onClick={()=>navigate('userlist')}>User List</button>
      </div>
      {loading ? (
        <p>Loading...</p>
